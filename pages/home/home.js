          ...
          project: [
            {
              ...
              content: [
                ...
                '目前该小程序已上线，平均每天有付费用户近千次，车流量2000次。',
              ]
            },
            {
              title: 'WMPF中台',
              type: '界面设计',
              content: [
                '项目描述:是我司与微信合作开发，用于管理连接的硬件设备与微信小程序。',
                '职责描述: 1.理解业务需求，了解小程序配置的流程; 2、分析数据信息的必要性，考虑表单之间的逻辑性，保证信息填写流畅以及信息的快速查询; 3、依据用户在操作过程中遇到的问题，调整设计，尽量减少用户输入的情况，多用复选框、单选框以及下拉菜单等选项降低用户的犯错率。',
              ]
            },
            {
              title: '电子报纸',
              type: '界面设计',
              content: [
                '项目描述：是我司与国家电网报合作开发的基于微信相框智能硬件的产品，用户可通过微信相框查看每期报纸内容。',
                '职责描述：1、梳理产品需求，熟悉业务，梳理逻辑；2、提供高保真的视觉效果图，跟进并配合开发人员进行项目开发；3、尝试运用heart模型，在同事间进行试验，依据反馈调整设计方案，减少用户的学习成本、提高效率。'
              ]
            }
          ]
        },
